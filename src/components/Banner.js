...
const Banner = () => {
    return (
        ...
        <Image objectFit="cover" layout="fill" src={"https://images.unsplash.com/photo-1671125239797-e731dae0accd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"}/>
